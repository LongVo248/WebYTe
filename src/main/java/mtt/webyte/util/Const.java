...
public class Const {
    private final static class SEND_MAIL_SUBJECT {
    ...
    private final static class TEMPLATE_FILE_NAME {
        public final static String CLIENT_REGISTER = "signup";
        public final static String CLIENT_FORGET_PASSWORD = "forgotpass";
